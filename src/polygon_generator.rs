...
impl PolygonGenerator {
    ...
    pub fn generate_object(
        ...
        let start_point_width = self.point_width(angle, position, &wall.start_point);
        let start_point_height = self.point_height(&position, &wall.start_point);
        let end_point_width = self.point_width(angle, position, &wall.end_point);
        let end_point_height = self.point_height(&position, &wall.end_point);
        return [
